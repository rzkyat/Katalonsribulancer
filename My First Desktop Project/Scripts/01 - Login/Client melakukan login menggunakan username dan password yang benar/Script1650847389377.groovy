...
WebUI.setText(findTestObject('Object Repository/Page_Login Sribulancer/input_Email  Username_input_l_username'), 'winarsosudibyomangun')

'Input password yang benar'
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login Sribulancer/input_Password_input_l_password'), '6MwV37pA8lCjSjYoku9s9Q==')
...
'Expected: Pada menu logo avatar profile apabila di klik akan tampil informasi "Sebagai Klien"'
WebUI.click(findTestObject('Object Repository/Page_Cari Freelancer Indonesia, Selesaikan _96a419/div_Sebagai Klien'))
